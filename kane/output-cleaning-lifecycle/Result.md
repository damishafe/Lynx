...
status: passed
started: 2026-08-21T07:33:25.851Z
duration_s: 144
session_id: ac8bfb1b-08fd-4fbe-931b-d1fdf5c2feae
---

# Cleaning lifecycle — checkout schedules exactly one turnover clean — Result

## Reset the demo account ✓ passed (0.99s)
...
## Create a booking for Unit 7 ✓ passed (2s)
...
## Check the guest out ✓ passed (0.67s)
...
## Exactly one cleaning job was created ✓ passed (74.3s)
...
## Unit 7 needs cleaning and refuses to be marked Ready ✓ passed (54.8s)
