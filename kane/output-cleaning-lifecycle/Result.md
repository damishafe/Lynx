...
status: passed
started: 2026-08-20T19:52:27.925Z
duration_s: 310
session_id: 42f1aa9f-0e9a-4f3e-943e-669d15b49d1b
---

# Cleaning lifecycle — checkout schedules exactly one turnover clean — Result

## Reset the demo account ✓ passed (25.4s)
...
## Create a booking for Unit 7 ✓ passed (53.4s)
...
## Check the guest out ✓ passed (49.6s)
...
## Exactly one cleaning job was created ✓ passed (106.2s)
...
## Unit 7 needs cleaning and refuses to be marked Ready ✓ passed (72.6s)
