...
status: passed
started: 2026-08-21T07:36:11.219Z
duration_s: 86
session_id: 9a871ec3-36ed-4500-a001-d7845dd2e55d
---

# Unit readiness — completing the clean pays the vendor once and frees the unit — Result

## Reset the demo account ✓ passed (1.06s)
...
## Create a booking and check the guest out ✓ passed (3.71s)
...
## Complete the cleaning job ✓ passed (1.51s)
...
## The vendor is owed exactly the cleaning fee ✓ passed (20.3s)
...
## Unit 7 is ready again ✓ passed (0.55s)
...
## The clean is charged once, not twice ✓ passed (55.2s)
md5: c415105fade81a57fb9f8deb34572b0a
